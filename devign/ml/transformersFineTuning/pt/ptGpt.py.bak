...
from transformers import GPT2Tokenizer, GPT2ForSequenceClassification, RobertaTokenizer, AutoTokenizer, RobertaTokenizer, AutoModelForSequenceClassification #, BertModel, BertTokenizer
...
if n_categories == 2 and sampling == True:
    ...
    target_count = class_counts[class_counts.idxmin()] # class_counts[class_counts.idxmin()] # int(class_counts.iloc[0] / 2)
